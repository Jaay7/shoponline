  ...
  return (
    <div className="relative bg-white">
      ...
      <header className="bg-white">
        <div className="relative isolate flex items-center justify-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-3 sm:px-3.5 sm:flex-1">
          <div
          ...
          <div className="flex items-center px-4 text-sm font-medium text-black sm:px-6 lg:px-8">
