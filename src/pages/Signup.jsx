...
const create_user = gql`
  mutation CreateUser($username: String!, $email: String!, $password: String!, $addressLine: String!, $pinCode: String!, $city: String!, $state: String!, $country: String!) {
    createUser(username: $username, email: $email, password: $password, addressLine: $addressLine, pinCode: $pinCode, city: $city, state: $state, country: $country) {
      message
      token
    }
  }
